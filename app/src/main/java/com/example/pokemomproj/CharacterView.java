...
public class CharacterView extends View {
    ...
    private Runnable manaRegenRunnable;
    ...
    public void startManaRegeneration() {
        if (manaRegenRunnable != null) return; // Đã đang hồi mana

        manaRegenRunnable = new Runnable() {
            @Override
            public void run() {
        ...
        post(manaRegenRunnable);
    }

    public void stopManaRegeneration() {
        if (manaRegenRunnable != null) {
            removeCallbacks(manaRegenRunnable);
            manaRegenRunnable = null;
        }
    }
